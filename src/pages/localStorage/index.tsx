      ...
      <VStack gap={6} align="stretch">
        ...
        <Box>
          ...
          <HStack>
            ...
            <Button colorScheme="blue" onClick={handleSetItem}>設定</Button>
          </HStack>
        </Box>
        ...
        <Box>
          ...
          <HStack>
            ...
            <Button colorScheme="green" onClick={handleGetItem}>取得</Button>
          </HStack>
        ...
        <Box>
          ...
          <HStack>
            ...
            <Button colorScheme="red" onClick={handleRemoveItem}>削除</Button>
          </HStack>
        </Box>
        ...
        <Box>
          ...
          <Button colorScheme="red" onClick={handleClear}>すべてクリア</Button>
        </Box>
        ...
        <Box>
          ...
          <HStack>
            ...
            <Button colorScheme="purple" onClick={handleGetKey}>取得</Button>
          </HStack>
        ...
        <Box>
          ...
          <Text>現在のキー数: <Badge colorScheme="blue">{length}</Badge></Text>
        </Box>
        ...
        <Box>
          ...
          <VStack gap={2}>
            ...
            <Button colorScheme="blue" onClick={handleSetMultipleItems}>複数設定</Button>
          </VStack>
        </Box>
        ...
        <Box>
          ...
          <HStack>
            ...
            <Button colorScheme="red" onClick={handleRemoveMultipleItems}>複数削除</Button>
          </HStack>
        </Box>
      </VStack>
    </Box>
